...
const ImagePicker: React.FC = () => {
  ...
  return (
    <div className="m-4">
      <p className="text-3xl text-black font-bold mb-1">Create new Skill</p>
      <p className="text-sm text-gray-500 mb-2">
        Please provide information for creating a new skill.
      </p>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Enter skill description in detail."
                      {...field}
                    />
                  </FormControl>
                  <FormDescription>
