...
const UpdateDepartment: React.FC<DepartmentProps> = ({ params }) => {
  ...
  const handleUpload = async (name: string, id: string) => {
    try {
      ...
      const apiUrl = "/api/department/update";
      ...
      <div className="flex flex-col w-[80vw]">
        <div className="flex">
          <div className="flex flex-col">
            <p className="text-3xl text-black font-bold">Update Department</p>
            <p className="text-sm text-gray-600 mb-2">
              Please provide updated information for department.
            </p>
          </div>
        </div>
